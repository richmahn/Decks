 ...
 * All ASLv2 licensed.
 */
public class ExpandableListFragment extends Fragment implements OnCreateContextMenuListener, ExpandableListView.OnChildClickListener,
	 ...
	 * have a sibling view id {@link android.R.id#empty android.R.id.empty} that is to be shown when the list is empty.
	 * <p/>
	 * <p>
	 ...
	 * once an mAdapter is given with {@link #setListAdapter(ListAdapter)}. If the list at that point had not been shown, when it does get shown it will be do
