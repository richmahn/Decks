...
public class Translate {
    ...
    private static final String TRANSLATE_URL_STRING = "http://ajax.googleapis.com/ajax/services/language/translate?v=1.0&langpair=";
    private static final String TEXT_VAR = "&q=";
    private static final String IMAGE_URL_STRING = "http://ajax.googleapis.com/ajax/services/search/images?v=1.0&q=";
     ...
     * @throws IOException
     */
	public static String findImage(String text) throws Exception {
        try {
            StringBuilder url = new StringBuilder();
            url.append(IMAGE_URL_STRING).append(URLEncoder.encode(text, ENCODING));
            ...
            try {
                ...
                JSONObject json = new JSONObject(result).getJSONObject("responseData").getJSONArray("results").getJSONObject(0);
    ...
    private static String retrieveTranslation(String text, String from, String to) throws Exception {
        try {
            StringBuilder url = new StringBuilder();
            url.append(TRANSLATE_URL_STRING).append(from).append("%7C").append(to);
