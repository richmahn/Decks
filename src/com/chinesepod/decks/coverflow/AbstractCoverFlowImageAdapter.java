package com.chinesepod.decks.coverflow;
...
/**
 * This class is an mAdapter that provides base, abstract class for images
 * mAdapter.
 * 
 */
public abstract class AbstractCoverFlowImageAdapter extends BaseAdapter {
	...
	/** The bitmap map. */
	protected final Map<Integer, WeakReference<Bitmap>> bitmapMap = new HashMap<Integer, WeakReference<Bitmap>>();
